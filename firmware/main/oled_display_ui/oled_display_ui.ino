...
void loop() {
  ...
  if (current_screen == 0) { // MENU SCREEN
    ...
    if ((interfaceBoard.digitalRead(BUTTON_UP_PIN) == LOW) && (button_up_clicked == 0)) { // Up button clicked - jump to previous menu item
    ...
    } else if ((interfaceBoard.digitalRead(BUTTON_DOWN_PIN) == LOW) && (button_down_clicked == 0)) { // Down button clicked - jump to next menu item
    ...
    if ((interfaceBoard.digitalRead(BUTTON_UP_PIN) == HIGH) && (button_up_clicked == 1)) {     // Unclick 
      button_up_clicked = 0;
    }
    if ((interfaceBoard.digitalRead(BUTTON_DOWN_PIN) == HIGH) && (button_down_clicked == 1)) { // Unclick
  ...
  if ((interfaceBoard.digitalRead(BUTTON_SELECT_PIN) == LOW) && (button_select_clicked == 0)) { // Select button clicked, jump between screens
  ...
  if ((interfaceBoard.digitalRead(BUTTON_SELECT_PIN) == HIGH) && (button_select_clicked == 1)) { // Unclick 
